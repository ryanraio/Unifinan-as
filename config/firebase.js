...
import { getFirestore } from 'firebase/firestore';  // Adicione esta linha para importar Firestore
...
export const db = getFirestore(app);  // Adicione esta linha para inicializar Firestore
